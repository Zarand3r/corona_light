...
if __name__ == '__main__':
    ...
    submissions = [f"{homedir}"+ '/sample_submission.csv', '../model1/version3_0/old/submission3_0_0.csv', '../model1/version3_0/old/submission3_0_1.csv', '../model1/version3_0/submission3_0_2.csv']
    scores = []
