...
sys.path.insert(1, f"{homedir}" + '/models/gaussian/')
import prototype_revised
import formatter2
...
if __name__ == '__main__':
	...
	submission = []
	output_dict = prototype_revised.multi_submission(end, death_metric="avg_deaths") #do regime next but not ready for fitQ
	...
	output_file = f'{homedir}/models/submissions/gaussian/predictions1.csv'
	...
	formatter2.reformat(output_file, save=True, fix=False, id="1")
