...
if __name__ == '__main__':
	...
	output_dict = fit_counties2_1.multi_submission(end, regime=False, weight=True, guesses=guesses, start=-7, quick=True, fitQ=False, death_metric="avg_deaths")
	...
	import json
	parameter_file = f"{homedir}/models/epidemiological/production/parameters/parameters2_1_1.csv"
