...
if __name__ == '__main__':
	...
	output_dict = fit_counties2_1.multi_submission(end, regime=False, weight=True, guesses=guesses, start=-4, quick=True, fitQ=False, death_metric="deaths", fix_nonconvergent=True) #do regime next but not ready for fitQ
