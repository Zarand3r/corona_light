...
if __name__ == '__main__':
	...
	output_dict = fit_counties2_1.multi_submission(end, regime=False, weight=False, guesses=guesses, start=-4, quick=True, fitQ=False, death_metric="avg_deaths", fix_nonconvergent=False)
	...
	output_file = 'predictions2_1_3.csv'
