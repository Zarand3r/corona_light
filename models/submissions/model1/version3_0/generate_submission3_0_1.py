...
if __name__ == '__main__':
	...
	output_dict = fit_counties3_0.multi_submission(end, bias=True, regime=False, weight=True, guesses=guesses, start=-4, quick=True, fitQ=False, death_metric="deaths", adaptive=False, fix_nonconvergent=False) #do regime next but not ready for fitQ
