...
if __name__ == '__main__':
	...
	output_dict = fit_counties2_1.multi_submission(end, regime=False, weight=True, guesses=guesses, start=-4, quick=True, fitQ=False, death_metric="deaths", fix_nonconvergent=False) #do regime next but not ready for fitQ
	...
	output_file = 'predictions2_1_0.csv'
	...
	formatter2.reformat(output_file, save=True, fix=False, id="2_1_0")

	import json
	parameter_file = f"{homedir}/models/epidemiological/parameters/parameters2_1_0.csv"
