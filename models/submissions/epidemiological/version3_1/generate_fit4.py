...
if __name__ == '__main__':
	...
	submission(start, end, guesses=guesses1, bias=True, weight=True, policy_regime=True, tail_regime=False, death_metric="deaths", adaptive=True, sub_id="4_1")
	submission(start, end, guesses=guesses2, bias=True, weight=True, policy_regime=True, tail_regime=False, death_metric="deaths", adaptive=True, sub_id="4_2")
