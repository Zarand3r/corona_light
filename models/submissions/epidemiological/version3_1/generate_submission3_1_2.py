...
if __name__ == '__main__':
	...
	output_dict = fit_counties3_0.multi_submission(end, bias=True, policy_regime=False, weight=True, guesses=guesses, error_start=0, quick=True, tail=-14, fitQ=False, death_metric="deaths", adaptive=True, fix_nonconvergent=False) #do regime next but not ready for fitQ
