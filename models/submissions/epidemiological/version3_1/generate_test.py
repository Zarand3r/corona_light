...
def main(start_date, end_date, guesses, bias=False, policy_regime=False, tail_regime=False, weight=True, error_start=0, quick=True, tail=False, fitQ=False, adaptive=False, death_metric="deaths", cutoff=None, fix_nonconvergent=False, sub_id="0"):
	submission = []
	output_dict = fit_counties3_0.multi_submission(end_date, bias=bias, policy_regime=policy_regime, tail_regime=tail_regime, weight=weight, guesses=guesses, error_start=start, quick=quick, fitQ=fitQ, adaptive=adaptive, death_metric=death_metric, cutoff=cutoff, fix_nonconvergent=fix_nonconvergent) #do policy_regime next but not ready for fitQ
...
if __name__ == '__main__':
	...
	main(start_date, end_date, guesses, bias=False, adaptive=False, cutoff=-14, fix_nonconvergent=True, sub_id="3_1_0")
	main(start_date, end_date, guesses, bias=True, adaptive=False, cutoff=-14, fix_nonconvergent=False, sub_id="3_1_1")
	main(start_date, end_date, guesses, bias=True, adaptive=True, cutoff=-14, tail=-14, fix_nonconvergent=False, sub_id="3_1_2")
	main(start_date, end_date, guesses, bias=True, tail_regime=True, adaptive=True, cutoff=-14, tail=-14, fix_nonconvergent=False, sub_id="3_1_3")
