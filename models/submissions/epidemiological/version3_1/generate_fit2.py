...
if __name__ == '__main__':
	...
	submission(start, end, guesses=guesses1, bias=True, weight=True, policy_regime=False, tail_regime=False, death_metric="avg_deaths", adaptive=False, sub_id="2_1")
	submission(start, end, guesses=guesses2, bias=True, weight=True, policy_regime=False, tail_regime=False, death_metric="avg_deaths", adaptive=False, sub_id="2_2")
