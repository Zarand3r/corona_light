...
if __name__ == '__main__':
	# use getbounds=False in generate_test to make old submissions have no error bound (0 standard deviation?) Maybe get rid of the one with just bias=True. Add the one with tail_regime=True
	# Train to get best county parameter dictionary on the old submissions and also create baseline file (with errors) with the new submissions (doesnt matter what error parameters)
	# Generate newer submissions from parameter dictionary with start = -14 or -7 (no cutoff, trained on most recent dat) use error parameters for weight, tail for confidence interval
	# Score all the newer submissions on dates since start to compare how effective confidence intervals are
	# Use the baseline to fill in the predictions before the latest_date
	start_date = '2020-05-07'
	latest_date = '2020-05-18'
	submissions = ['../old_submissions/submission3_1_0.csv', '../old_submissions/submission3_1_1.csv', '../old_submissions/submission3_1_2.csv', '../old_submissions/submission3_1_3.csv', f'{homedir}/sample_submission.csv']
	...
	new_submissions = ['../new_submissions/submission3_1_0.csv', '../new_submissions/submission3_1_1.csv', '../new_submissions/submission3_1_2.csv', '../new_submissions/submission3_1_3.csv', f'{homedir}/sample_submission.csv']
	scores = []
	...
	output_file = f'{homedir}/models/submissions/epidemiological/version3_1/optimize/combined.csv'
