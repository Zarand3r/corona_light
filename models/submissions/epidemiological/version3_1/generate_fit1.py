...
if __name__ == '__main__':
	...
	generate_submission(start, end, guesses=guesses1, bias=True, weight=True, policy_regime=False, tail_regime=False, death_metric="deaths", adaptive=False, sub_id="1_1")
	generate_submission(start, end, guesses=guesses2, bias=True, weight=True, policy_regime=False, tail_regime=False, death_metric="deaths", adaptive=False, sub_id="1_2")
