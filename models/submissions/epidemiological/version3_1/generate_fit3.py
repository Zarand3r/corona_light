...
if __name__ == '__main__':
	...
	generate_submission(start, end, guesses=guesses1, bias=True, weight=True, policy_regime=False, tail_regime=-14, death_metric="deaths", adaptive=True, sub_id="3_1")
	generate_submission(start, end, guesses=guesses2, bias=True, weight=True, policy_regime=False, tail_regime=-14, death_metric="deaths", adaptive=True, sub_id="3_2")
