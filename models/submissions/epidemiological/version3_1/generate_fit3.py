...
if __name__ == '__main__':
	...
	submission(start, end, guesses=guesses1, bias=True, weight=10, policy_regime=False, tail_regime=True, death_metric="deaths", adaptive=False, sub_id="3_1")
	submission(start, end, guesses=guesses2, bias=True, weight=10, policy_regime=False, tail_regime=True, death_metric="deaths", adaptive=False, sub_id="3_2")
