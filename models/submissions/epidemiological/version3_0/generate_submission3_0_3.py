...
if __name__ == '__main__':
	...
	output_dict = fit_counties3_0.multi_submission(end, bias=True, regime=True, weight=True, guesses=guesses, start=0, quick=True, fitQ=False, death_metric="deaths", adaptive=True, fix_nonconvergent=False) #do regime next but not ready for fitQ
	...
	output_file = f'{homedir}/models/submissions/epidemiological/version3_0/' + 'predictions3_0_3.csv'
