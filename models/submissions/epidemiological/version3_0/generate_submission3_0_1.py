...
if __name__ == '__main__':
	...
	output_dict = fit_counties3_0.multi_submission(end, bias=True, policy_regime=False, tail_regime=False, weight=True, guesses=guesses, error_start=-14, quick=True, fitQ=False, death_metric="deaths", adaptive=False, fix_nonconvergent=False) #do regime next but not ready for fitQ
	...
	output_file = f'{homedir}/models/submissions/epidemiological/version3_0/new_submissions/predictions3_0_1.csv'
	...
	formatter2.reformat(output_file, save=True, fix=False, id="3_0_1")

	import json
	parameter_file = f"{homedir}/models/epidemiological/parameters/parameters3_0_1.csv"
