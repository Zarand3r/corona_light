...
if __name__ == '__main__':
	...
	output_file = f'{homedir}/models/submissions/epidemiological/version3_0/' + 'predictions3_0_4.csv'
	...
	formatter2.reformat(output_file, save=True, fix=False, id="3_0_4")

	import json
	parameter_file = f"{homedir}/models/epidemiological/parameters/parameters3_0_4.csv"
