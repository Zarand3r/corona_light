...
def main(start, end, guesses, bias=False, regime=False, weight=True, start=0, quick=True, fitQ=False, adaptive=False, death_metric="deaths", cutoff=None, fix_nonconvergent=False, sub_id="0"):
	submission = []
	output_dict = fit_counties3_0.multi_submission(end, bias=bias, regime=regime, weight=weight, guesses=guesses, start=start, quick=quick, fitQ=fitQ, adaptive=adaptive, death_metric=death_metric, cutoff=cutoff, fix_nonconvergent=fix_nonconvergent) #do regime next but not ready for fitQ
...
if __name__ == '__main__':
	...
	main(start, end, guesses, bias=False, adaptive=False, cutoff=-10, fix_nonconvergent=True, sub_id="3_0_0")
	main(start, end, guesses, bias=True, adaptive=False, cutoff=-10, fix_nonconvergent=False, sub_id="3_0_1")
	main(start, end, guesses, bias=True, adaptive=True, cutoff=-10, fix_nonconvergent=False, sub_id="3_0_2")
