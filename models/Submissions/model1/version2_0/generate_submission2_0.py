...
if __name__ == '__main__':
	...
	counties_dates, counties_death_errors, counties_fips, nonconvergent, parameters = fit_counties2_0.submission(end, weight=True, guesses=guesses, start=-6, quick=False)
	...
	output_file = 'predictions2_0.csv'
	...
	output_file = daily.convert(output_file, directory=f"{homedir}" + "/models/submissions/model1/version2_0/")
