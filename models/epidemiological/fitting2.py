...
def get_deaths(res, data, extrapolate=1):   
...
def plot_with_errors_sample(res, p0_params, p0_initial_conditions, data, extrapolate=1, boundary=None, plot_infectious=False):
	print(res.x)
	print(res.fun)
	print(res.cost)
	errors = get_errors2(res, list(p0_params) + list(p0_initial_conditions))
...
def main():
	...
	initial_conditions = [0.75, 0.25, 1e-5, 4e-6, 0, 0, 0]
	initial_ranges = [(0,1), (0,1), (0,0.01), (0,0.01), (0,0.01), (0,0.01), (0,0.01)]
	# guesses = params + initial_conditions
	guesses = [9e-02, 1e-01, 7e-02, 3.e-01, 4.e-01, 1e-01, 1e-01, 3e-01, 4e-01, 7e-02, 2e-04, 8e-02, 7e-03, 2e-02, 2e-04, 2e-06, 4e-03, 7e-01, 2e-01, 4e-08, 7e-03, 1e-08, 3e-20, 7e-04]
	...
	for boundary in [40]:
		...
		# plot_with_errors_sample(res, params, initial_conditions, lombardia, extrapolate=1, boundary=boundary, plot_infectious=False)
		predictions = get_deaths(res, lombardia, extrapolate=1)
		parameters = res.x 
		print(predictions)
		print(parameters)
